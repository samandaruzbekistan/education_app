...
import 'package:forlesson/widgets/FourLessons.dart';
...
class FourClass extends StatefulWidget {
  const FourClass({Key? key}) : super(key: key);

  @override
  State<FourClass> createState() => _FourClassState();
}

class _FourClassState extends State<FourClass> {
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            SizedBox(height: 10,),
            isLessonSection ? FourLessons() : FourDescription(),
          ],
        ),
      ),
    );
