...
class TwoClass extends StatefulWidget {
  const TwoClass({Key? key}) : super(key: key);

  @override
  State<TwoClass> createState() => _TwoClassState();
}

class _TwoClassState extends State<TwoClass> {
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            SizedBox(height: 10,),
            isLessonSection ? TwoLessons() : TwoDescription(),
          ],
        ),
      ),
    );
